public class main {
	...
	public static void main(String args[]) {
		int input = -40;
		System.out.println("µØ¤óÂàÄá¤ó  " + FahToCels(input));
		System.out.println("Äá¤óÂàµØ¤ó  " + CelsToFah(input));
		System.out.println("³Í¤óÂàÄá¤ó  " + KayToCels(input));
		System.out.println("Äá¤óÂà³Í¤ó " + CelsToKay(input));
		System.out.println("µØ¤óÂà³Í¤ó " + FahToKay(input));
		System.out.println("³Í¤óÂàµØ¤ó " + KayToFah(input));
	}
}
